...
function App() {
  ...
  const sections = [
    ...
    },
    {
      ...
      layout: "image-left",
      title: "Lead Singer",
      text: "Magdalena (Magz)<br /><br />Född och uppvuxen i Göteborg.<br /><br />Favoritband/influenser: Slipknot, Deftones, Halestorm.",
      image: `${import.meta.env.BASE_URL}assets/Singer.jpg`,
    },
    {
      type: "content",
      layout: "image-right",
      ...
      image: `${import.meta.env.BASE_URL}assets/Vocalist.jpg`,
      flipImage: true,
    },
    {
      type: "content",
    ...
    <div className="app">
      {currentSectionData.type === "landing" ? (
        <div
          ...
          style={{
            backgroundImage: `url(${currentSectionData.backgroundImage})`,
          }}
        ></div>
        ...
        >
          <div className="news-layout">
            ...
            <div className="news-content-container">
              <div className="news-box flex">
                <p className="news-text">
                  Vi har nu en ny Facebook sida!
                  <br />
                  <br />
                  För att följa oss på våra sociala medier och få de senaste
                  uppdateringarna. Scrolla längst ner på sidan!
                  <br />
                  Här kan du även få det senaste uppdateringarna samt höra våra
                  nya låtar och se uppkommande spelningar!
                  <br />
          ...
          <div className="about-layout">
            ...
            <div className="about-content-container">
              <p className="about-text">
                ...
                <br />
                <br />
                För tillfället är vi fortfarande under process med rep och låt
                skrivning men allt rullar på så vi hoppas på att allt ska va
                full go till efter nyår.
                <br />
                <br />
                Följ oss på våra sociala medier för mer updates om kommande
                låtar och spelningar!
              </p>
          ...
          <div className="background-layout">
            ...
            <div className="background-content-container">
              <p className="background-text">
                I skuggorna av Göteborg föddes Zinzeria år 2025 – ett fantasy
                metalband där verklighet möter saga. Med symfoniska
                arrangemang, tunga riff och en sång som växlar mellan mäktiga
                growls och klara melodiska toner, målar vi musikaliska världar
                fyllda av ljus och mörker.
                <br />
                <br />
                Varje låt är en berättelse. Våra refränger bär på episka
                stämningar som stannar kvar länge efter sista tonen, och våra
                konserter blir resor där publiken får kliva in i en annan
                verklighet. Inspirerade av klassisk metal och tidlösa myter
                skapar vi något eget – en fantasyvärld i ljudets form.
                <br />
                <br />
                Bandet består av fem passionerade musiker, förenade av
                kärleken till tung musik, starka känslor och kraftfulla
                framträdanden. Tillsammans är vi Zinzeria – där musiken blir
                magi och fantasin får liv.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="contact-layout">
            ...
            <div className="social-media-container">
              ...
              <div className="social-icons">
                ...
                <a
                  href="https://www.facebook.com/profile.php?id=61556474100667"
          ...
          <div className={`content-layout ${currentSectionData.layout}`}>
            <div className="text-container">
              ...
              <p
                ...
                dangerouslySetInnerHTML={{ __html: currentSectionData.text }}
              ></p>
            </div>
            <div className="image-container">
              <img
                ...
                className={`content-image ${
                  currentSectionData.flipImage ? "flipped" : ""
                }`}
              />
            </div>
          </div>
